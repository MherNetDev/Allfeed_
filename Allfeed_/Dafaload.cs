...
namespace Dafag
{
    internal class Dafaload
    {
        ...
        public string currentPeriodAbbreviation { get; set; }
        ...
        public object gameCode { get; set; }
    ...
    public class Market
    {
        ...
        public object cutoffTime { get; set; }
        public long startTimeInRunning { get; set; }
    }
    ...
    public class Book
    {
        public Placeterm[] placeTerms { get; set; }
        public string description { get; set; }
